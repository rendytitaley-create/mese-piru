...
  const dashboardStats = useMemo(() => {
    // Logika pemilihan rentang bulan untuk Rekap (Instruksi: Triwulan & Tahunan)
...
      
      // LOGIKA PENCARIAN NAMA DEPAN (FIRST WORD MATCH) - Akumulatif Periode
...
    const myKJK = minutesToTimeStr(myTotalMins);
    ...
    // Hitung Rekap Tahunan untuk Kartu Pegawai (Instruksi: Menampilkan kartu dashboard masing-masing)
...
             <div className="hidden md:flex items-center gap-3">
               {/* MODIFIKASI: Toggle Rekap Dashboard untuk Admin & Pimpinan */}
...
                  </div>
                  ...
                  {/* MODIFIKASI: Kartu Rekap Tahunan untuk setiap pegawai */}
